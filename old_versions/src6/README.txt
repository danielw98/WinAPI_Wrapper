...
- make error functions and a getError function
...
is user written, but the event loop is taken care of by the library, with the user supplying the callbacks if necessary
